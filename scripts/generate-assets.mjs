#!/usr/bin/env node
/**
 * Generates every brand asset for Loopwits from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"path","points":[[0.5,0.17],[0.86,0.79],[0.14,0.79],[0.5,0.17]],"w":0.1,"fill":"accentMid"},{"type":"circle","cx":0.5,"cy":0.17,"r":0.165,"fill":"accent"},{"type":"circle","cx":0.86,"cy":0.79,"r":0.14,"fill":"accentLight"},{"type":"circle","cx":0.14,"cy":0.79,"r":0.14,"fill":"accentMid"}];
 ...
 */
const MARK = [[0.12,1,1,1,0.12],[1,0.12,0.12,0.12,1],[1,0.12,0.45,0.12,1],[1,0.12,0.12,0.12,1],[0.12,1,1,1,0.12]];
...
console.log('Generating Loopwits brand assets\n');
