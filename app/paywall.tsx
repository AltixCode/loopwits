...
const BENEFITS = ["The full puzzle archive, every day back to launch","No ads, ever","Unlimited hints across all three puzzle types","Detailed streak and solve-time stats"];
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.background, paddingTop: insets.top }}>
      ...
      <ScrollView contentContainerStyle={{ padding: spacing.xl, paddingBottom: spacing['3xl'] }}>
        <Text variant="display">Loopwits Pro</Text>
        <Text variant="body" tone="muted" style={{ marginTop: spacing.sm }}>
          Three tiny logic puzzles a day. One streak.
        </Text>
